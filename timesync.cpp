...
static TickType_t TimeSync_RefTick;    // [ms] reference point on the system tick
static uint32_t   TimeSync_RefTime;    // [ s] UTC time which corresponds to the above reference point
